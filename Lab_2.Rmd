...
```{r}
inner_fligths_planes <-   inner_join(flights,planes, by = "tailnum")
inner_fligths_planes
```

1.2. Conecte fligths con airlines
```{r}
inner_fligths_airlines <-   inner_join(flights,airlines, by = "carrier")
inner_fligths_airlines
```
...
```{r}
airlines_flights_selected <- flights_selected %>%
